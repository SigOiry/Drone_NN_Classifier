...
rast <- rast("Data/img/Belon_1104_MS.tif") 

shp <- read_sf("Data/shp/Training_Belon_1104/Training_Belon_1104.shp")
...
old_data <- read.delim("D:/Git_repo/Drone_NN_Classifier/Data/Training/DISCOV_BiCOME_Training_reframed.csv", sep=";")
  

new_training_data <- rbind(df,old_data)

utils::write.table(new_training_data, "Data/Training/DISCOV_Invasea.csv", sep = ";", quote = FALSE, row.names = FALSE) 
