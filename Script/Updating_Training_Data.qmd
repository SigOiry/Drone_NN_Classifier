...
shp <- read_sf("Data/shp/Training_Belon_1004/Training_Belon_1004.shp")
...
old_data <- read.delim("Data/Training/DISCOV_Invasea.csv", sep=";")
  

new_training_data <- rbind(df,old_data)

utils::write.table(new_training_data, "Data/Training/DISCOV_Invasea_V2.csv", sep = ";", quote = FALSE, row.names = FALSE) 
